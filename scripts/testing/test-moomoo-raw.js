...
try {
  // For local OpenD Gateway, key is typically not required
  // The key in the process is already MD5 hashed, and the API would hash it again (double-hash)
  console.log('Attempting connection without WebSocket key (local gateway)...');
