...
class AutoSetup {
    ...
    async setupStripe(email, password) {
        ...
        try {
            ...
            const testPublishableKey = await this.page.locator('text=Publishable key >> following-sibling::div').first().textContent();
            ...
            await this.page.fill('input[placeholder="https://example.com/webhook"]', 'https://your-domain.com/webhook/stripe');
