...
describe('WebSocketServer', () => {
    ...
    describe('Constructor & Initialization', () => {
        test('should initialize WebSocket server with correct CORS configuration', () => {
            ...
            expect(socketIO).toHaveBeenCalledWith(mockHttpServer, expect.objectContaining({
    ...
    describe('Event Handlers - Subscriptions', () => {
        ...
        test('should handle portfolio subscription', () => {
            const subscribeHandler = mockSocket.on.mock.calls.find(
                call => call[0] === 'subscribe:portfolio'
            )[1];
        ...
        test('should handle watchlist subscription with valid symbols', () => {
            const subscribeHandler = mockSocket.on.mock.calls.find(
                call => call[0] === 'subscribe:watchlist'
            )[1];
        ...
        test('should handle watchlist unsubscription', () => {
            const unsubscribeHandler = mockSocket.on.mock.calls.find(
                call => call[0] === 'unsubscribe:watchlist'
            )[1];
    ...
    describe('Emit Methods', () => {
        ...
        test('should not emit portfolio update without userId', () => {
            ...
            expect(consoleWarnSpy).toHaveBeenCalledWith(
                expect.stringContaining('Invalid portfolio update')
            );
        ...
        test('should emit market status to all clients', () => {
            ...
            expect(mockIO.emit).toHaveBeenCalledWith('market:status', expect.objectContaining({
                isOpen: true
            }));
        });
        ...
        test('should not emit quote update for invalid data', () => {
            ...
            expect(consoleWarnSpy).toHaveBeenCalledWith(
                expect.stringContaining('Invalid quote update')
            );
