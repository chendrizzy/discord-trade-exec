class PerformanceTracker {
    ...
    getMetrics() {
        ...
        return {
            ...
            trades: {
                ...
                successRate: this.metrics.trades.total > 0 
            ...
            rateLimiting: {
                ...
                blockRate: (this.metrics.rateLimiting.requestsAllowed + this.metrics.rateLimiting.requestsBlocked) > 0
                    ? (this.metrics.rateLimiting.requestsBlocked / (this.metrics.rateLimiting.requestsAllowed + this.metrics.rateLimiting.requestsBlocked) * 100).toFixed(2)
                    : 0,
    ...
    checkSystemHealth(systemMetrics) {
        if (systemMetrics.memoryUsage.rss > 1024 * 1024 * 1024) { // 1GB
