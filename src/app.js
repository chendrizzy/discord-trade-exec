...
const communityIntegrationRoutes = require('./routes/api/community-integration');
const communityBillingRoutes = require('./routes/api/community-billing');
const traderRoutes = require('./routes/api/trader');
const traderBotsRoutes = require('./routes/api/trader-bots');
...
function createApp(options = {}) {
  ...
  app.use('/api/community/integration', communityIntegrationRoutes);
  app.use('/api/community/billing', communityBillingRoutes);
  app.use('/api/trader', traderRoutes);
  app.use('/api/trader/bots', traderBotsRoutes);
