...
class DiscordTradeBot {
        ...
        try {
            ...
            if (!user) {
                ...
                const welcomeEmbed = new EmbedBuilder()
                    ...
                    .setColor(0x00ff00)
                    .addFields(
                        { name: 'Trial Includes', value: '✅ 10 signals/day\n✅ Auto trade execution\n✅ Basic risk management', inline: false },
    ...
    async executeTradeForUser(signal, user, messageOrInteraction) {
        try {
            ...
            if (result.success) {
                ...
                embed.addFields(
                    { name: 'Reason', value: result.reason || 'Unknown error', inline: false }
                );
            }
    ...
    async handleStatsCommand(interaction) {
        ...
        const winRate = user.stats.totalTradesExecuted > 0
