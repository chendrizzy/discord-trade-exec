            ...
            <CardHeader>
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <CardDescription>
                            Real-time market quotes for your watched symbols
                        </CardDescription>
                    </div>
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2 mb-1">
                                                ...
                                                {quote && (
                                                    <Badge
                                                        variant={changePositive ? 'profit' : 'loss'}
                                                        className="text-xs"
                                                    >
                                        ...
                                        <div className="text-right">
                                            <div
                                                className={`text-2xl font-black font-mono transition-colors duration-300 ${
                                                    priceChange === 'increase' ? 'text-profit-text' :
                                                    priceChange === 'decrease' ? 'text-loss-text' :
                                                    'text-foreground'
                                                }`}
                                                aria-live="polite"
                                                aria-atomic="true"
                                            ...
                                            {quote && (
                                                <div className="flex items-center gap-2 justify-end mt-1">
                                                    <span className={`text-xs font-mono ${changePositive ? 'text-profit-text' : 'text-loss-text'}`}>
                                                        {changePositive ? '+' : ''}{formatPrice(quote.change)}
                                                    </span>
                                                    {quote.volume && (
