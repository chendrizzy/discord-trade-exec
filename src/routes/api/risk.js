    ...
    try {
        ...
        res.json({
            ...
            dailyLoss: {
                ...
                maxLossPercentage: ((lossCheck.maxLoss || req.user.tradingConfig.riskManagement.maxDailyLoss) * 100).toFixed(2) + '%',
